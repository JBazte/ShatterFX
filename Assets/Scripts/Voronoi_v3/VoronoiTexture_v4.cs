...
public class VoronoiTexture_v4 : MonoBehaviour {
    ...
    private void orderVerticesForNewMesh() {
        ...
        //3� Ordenar ambos grupos para que los v�rtices ets�n ordenados en sentido antihorario (por encima--> de mayor a menor; por debajo --> de menor a mayor)
        //4� Juntarlos
        ...
        for (int v = 0; v < listVerticesArea.Length; v++) {
            ...
            /*Debug.Log("Orden v�rtices de arriba:\n");
            for (int i = 0; i < topVertices.Count; i++)
            {
                Debug.Log(topVertices[i]);
            }
            Debug.Log("Orden v�rtices de abajo:\n");
